...
App.state = {
  ...
  // LINK_FACTOR × the median plot spacing of anything else joins the same
  // group — and a group counts as an outlier when it is both small and far.
  ...
  //
  // LINK_FACTOR above has no slider on purpose: it decides what counts as one
  // place, and exposing it would offer the user a chance to split a village
  ...
  // hides the case the feature exists for, since a 30 × 30 m plot between two
